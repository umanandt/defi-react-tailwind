...
<div>
        <h3 className="font-bold text-xl border-b-4 border-[#00d8ff] inline-block mt-4">Services</h3>
        <ul>
          <li>App</li>
          <li>Analytics</li>
          <li>Token</li>
      ...
      <div>
        <h3 className="font-bold text-xl border-b-4 border-[#00d8ff] inline-block mt-4">Types</h3>
        <ul>
          <li>App</li>
          <li>Analytics</li>
          <li>Token</li>
